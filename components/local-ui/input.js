  ...
  return (
    <>
      <Label className={cn("relative block h-auto", className)}>
        ...
        <div className="h-auto relative overflow-y-visible">
          {type !== "textarea" ? (
            type === "tel" ? (
              <div
                className={cn(
                  "border-2 h-10 w-full lg:h-14 rounded-md flex  overflow-y-visible border-black",
              ...
              >
                ...
                <_Input
                  ...
                  type={inputType}
                  className="h-full bg-inherit lg:h-full overflow-y-visible border-none"
                  {...props}
                />
              </div>
            ) : (
